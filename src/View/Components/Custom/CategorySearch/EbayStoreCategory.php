 ...
 */
class EbayStoreCategory extends Component
{
    public string $apiUrl = 'api/channel-lister/getEbayStoreCategoryOptions/';
    ...
    {
        return view('channel-lister::components.custom.category-search.ebay-store-category');
    }
}
