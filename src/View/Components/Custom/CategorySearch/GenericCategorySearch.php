 ...
 */
class GenericCategorySearch extends Component
{
    public function __construct(public ChannelListerField $params, public string $apiUrl = '', public string $classStrDefault = 'form-control')
    {
        //
    }
    ...
    public function render()
    {
        ...
        return view('channel-lister::components.custom.category-search.generic-category-search', [
            'params' => $this->params,
