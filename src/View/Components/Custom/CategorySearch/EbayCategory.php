 ...
 */
class EbayCategory extends Component
{
    public string $apiUrl = 'api/channel-lister/getEbayCategoryOptions/';
    ...
    {
        return view('channel-lister::components.custom.category-search.ebay-category');
    }
}
