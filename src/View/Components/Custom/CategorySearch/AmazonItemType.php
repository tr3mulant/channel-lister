 ...
 */
class AmazonItemType extends Component
{
    public string $apiUrl = 'api/channel-lister/getAmazonItemTypeOptions/';
    ...
    {
        return view('channel-lister::components.custom.category-search.amazon-item-type');
    }
}
