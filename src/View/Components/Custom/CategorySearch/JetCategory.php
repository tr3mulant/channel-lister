 ...
 */
class JetCategory extends Component
{
    public string $apiUrl = 'api/ChannelLister/getJetCategoryOptions/';
    ...
    {
        return view('channel-lister::components.custom.category-search.jet-category');
    }
}
