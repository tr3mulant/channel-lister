 ...
 */
class WalmartSubcategory extends Component
{
    public string $apiUrl = 'api/ChannelLister/getWalmartSubcategoryOptions/';
    ...
    {
        return view('channel-lister::components.custom.category-search.walmart-subcategory');
    }
}
