 ...
 */
class EbayCategoryHtml extends Component
{
    public string $apiUrl = 'api/ChannelLister/getEbayCategoryOptions/';
    ...
    {
        return view('channel-lister::components.custom.category-search.ebay-category-html');
    }
