 ...
 */
class WalmartCategoryHtml extends Component
{
    public string $apiUrl = 'api/ChannelLister/getWalmartCategoryOptions/';
    ...
    {
        return view('channel-lister::components.custom.category-search.walmart-category-html');
    }
}
