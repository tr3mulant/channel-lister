    ...
    <div class="input-group">
        ...
        <div class="input-group-append">
            <button type="button" class="btn btn-outline-primary"
                onclick="showShippingCalculator('{{ $id }}')">
        ...
        <div class="modal-content">
                ...
                <div id="shipping-calculator-{{ $id }}" class="shipping-calculator-container">
                    ...
                    <div id="manual-shipping-section-{{ $id }}" style="display: none;">
                        <div class="form-group">
                            <label class="col-form-label" for="manual-shipping-cost-{{ $id }}">Enter Shipping
                                Cost</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">$</span>
                                ...
                                <input type="number" class="form-control"
                                    id="manual-shipping-cost-{{ $id }}" step="0.01" min="0"
                                    placeholder="0.00">
                            </div>
                    ...
                    <div id="api-calculation-section-{{ $id }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-form-label" for="from-zip-{{ $id }}">From ZIP
                                        Code</label>
                                    <input type="text" class="form-control" id="from-zip-{{ $id }}"
                                        placeholder="98225" maxlength="5">
                                    <small class="form-text text-muted">
                                        <button type="button" id="detect-location-{{ $id }}"
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="col-form-label" for="package-length-{{ $id }}">Length
                                        (in)</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="col-form-label" for="package-width-{{ $id }}">Width
                                        (in)</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="col-form-label" for="package-height-{{ $id }}">Height
                                        (in)</label>
                                    <input type="number" class="form-control"
                                        id="package-height-{{ $id }}" step="0.1" min="0.1"
                                        placeholder="6">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="col-form-label" for="package-weight-{{ $id }}">Weight
                                        (lbs)</label>
                                    <input type="number" class="form-control"
                                        id="package-weight-{{ $id }}" step="0.1" min="0.1"
                                        placeholder="2.5">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="button" id="autofill-dimensions-{{ $id }}"
                                class="btn btn-sm btn-info">
                                <i class="fas fa-magic"></i> Auto-fill from Form Data
                            </button>
                            <small class="form-text text-muted">
                                Automatically populate dimensions from ship_length, ship_width, ship_height, and
                                ship_weight fields
                            </small>
                        </div>

                        <!-- Dimensional Weight Info -->
                        <div id="dimensional-weight-info-{{ $id }}" class="alert alert-info"
                            style="display: none; position: relative;">
                            <button type="button" class="btn btn-sm btn-outline-secondary"
                                onclick="document.getElementById('dimensional-weight-info-{{ $id }}').style.display='none';"
                                style="position: absolute; top: 10px; right: 10px; padding: 2px 8px; font-size: 12px;">
                                ×
                            </button>
                        ...
                        <!-- Calculate Button -->
                        <div class="form-group">
                            <button type="button" id="calculate-shipping-{{ $id }}"
                                class="btn btn-primary">
                                <span id="calculate-spinner-{{ $id }}"
                            ...
                            <button type="button" id="calculate-dimensional-weight-{{ $id }}"
                        ...
                        <div id="shipping-results-{{ $id }}" style="display: none;">
                            ...
                            <div id="shipping-rates-list-{{ $id }}"
                                style="max-height: 300px; overflow-y: auto; border: 1px solid #ddd; border-radius: 4px; background-color: #fafafa;">
                            </div>
                            ...
                            <div id="selected-cost-section-{{ $id }}" style="display: none;">
                                <div class="form-group mt-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control"
                                            id="selected-shipping-cost-{{ $id }}" step="0.01"
                                            min="0" readonly>
                                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success"
                    onclick="useCalculatedShipping('{{ $id }}')">
        ...
        document.getElementById(`detect-location-${fieldId}`)?.addEventListener('click', async function() {
            try {
                ...
                if (location.success && location.zip_code) {
                    ...
                    button.innerHTML =
                        `<i class="fas fa-check"></i> Detected: ${location.city}, ${location.state}`;
        ...
        try {
            ...
            if (hasApiKey) {
                ...
                statusMessage.innerHTML =
                    '<i class="fas fa-check-circle"></i> API available - automatic calculations enabled';
                ...
                statusMessage.innerHTML =
                    '<i class="fas fa-exclamation-triangle"></i> API not configured - please enter shipping cost manually';
                statusMessage.style.display = 'block';
